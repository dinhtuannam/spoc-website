        ...
        <div className="absolute top-[-60px] w-full">
            <div className="mx-4 laptop:mx-auto laptop:w-[90%] desktop:w-[80%]">
                <div className="bg-orange-500 text-white rounded-md">
                    <div className="flex flex-col laptop:flex-row items-center justify-between p-4 laptop:p-8 desktop:p-10">
                        {/* Title Section */}
                        <div className="w-full laptop:w-1/2 mb-4 laptop:mb-0 laptop:pr-8">
                        ...
                        <div className="w-full laptop:w-1/2">
                            <div className="flex max-w-[500px] mx-auto laptop:mx-0">
                                <input
                                    type="text"
                                    value={input}
                                ...
                                />
                                <button className="bg-black text-white px-4 py-3 rounded-r-md hover:bg-gray-800 transition-colors whitespace-nowrap">
                                    GỬI NGAY
                                </button>
                            </div>
                        </div>
